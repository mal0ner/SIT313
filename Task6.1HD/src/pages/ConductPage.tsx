    ...
    <div className="flex flex-col gap-6 p-10 items-center justify-center text-slate-500 text-xs sm:text-sm md:text-md lg:text-lg text-justify">
      ...
      <section className="flex flex-col gap-3 w-full">
        <p>
          ...
          inclusive environment for all users. Our community is built on trust,
          professionalism, and respect. By using our platform, you agree to
      ...
      <section className="flex flex-col gap-3 w-full">
        ...
        <ul className="flex flex-col gap-3">
          ...
          <li>
            ...
            This includes but is not limited to discrimination based on race,
            gender, religion, nationality, age, disability, or sexual
            orientation.
          </li>
          <li>
      ...
      <section className="flex flex-col gap-3 w-full">
        ...
        <p>
          ...
          place are always welcome. <br />
          <br />
          By using DevLink Marketplace, you agree to adhere to this code of
          conduct. We reserve the right to modify or update these guidelines as
          needed to ensure a safe and productive environment for all users.
          <br />
          <br />
