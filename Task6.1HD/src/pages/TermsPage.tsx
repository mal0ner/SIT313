    ...
    <div className="flex text-xs text-slate-500 sm:text-sm md:text-md lg:text-lg flex-col gap-6 p-10 items-center justify-center text-justify">
      ...
      <section className="flex flex-col gap-3 w-full">
        <p>
          ...
          users, including freelance developers and potential employers agree to
          be bound by these Terms of Service. These terms constitute a legally
          binding agreement between DevLink Marketplace and its users.
        </p>
      </section>
      <section className="flex flex-col gap-3 w-full">
        ...
        <p>
          ...
          right to deny service, terminate accounts, or remove content in its
          sole discretion if any user is found to violate the eligibility
          criteria.
        </p>
      </section>
      <section className="flex flex-col gap-3 w-full">
        ...
        <p>
          ...
          credentials and for all activities that occur under their account. Any
          unauthorized use of accounts must be reported immediately to DevLink
          Marketplace.
        </p>
      </section>
      <section className="flex flex-col gap-3 w-full">
        ...
        <p>
          ...
          and must ensure that it complies with all applicable laws,
      ...
      <section className="flex flex-col gap-3 w-full">
        ...
        <p>
          ...
          communicated to users before they incur charges. All payments must be
          made in accordance with the designated payment methods provided on the
          Platform.
        </p>
      </section>
      <section className="flex flex-col gap-3 w-full">
      ...
      <section className="flex flex-col gap-3 w-full">
        ...
        <div className="flex flex-col gap-1 text-left">
          ...
          <p>
            <span className="font-bold">B. </span>Violate any applicable laws or
            regulations
          </p>
          <p>
      ...
      <section className="flex flex-col gap-3 w-full">
        ...
        <p>
          ...
          continued use of the Platform after the modifications signify
